...
def add_clock(img):
	color = (16, 16, 16)
	#clock_img = cv2.rectangle(img, (11, 11), (100, 35), color, -1)  # Добавить размытое изображение
	clock_img = cv2.rectangle(img, (11, 11), (100, 35), color, -1) # Добавить чёткое изображение со сдвигом

	font = cv2.FONT_HERSHEY_TRIPLEX #Изменить шрифт на FONT_HERSHEY_TRIPLEX (FONT_HERSHEY_SCRIPT_SIMPLEX)
